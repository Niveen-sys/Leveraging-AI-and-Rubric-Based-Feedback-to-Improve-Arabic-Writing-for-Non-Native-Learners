...
with col_left:
    ...
    # Custom styling for student name input
    st.markdown("""
    <style>
    div[data-testid="stTextInput"] input[aria-label="Student Name"] {
        ...
        with st.spinner("🔍 Reading Learning Objective..."):
            try:
                ...
                if lo_extracted:
                    ...
                    # Custom styled text area for LO preview
                    st.markdown("""
                    <style>
                    div[data-testid="stTextArea"] textarea[aria-label="Extracted LO (edit if needed):"] {
                        color: #000000 !important;
                        font-family: 'Calibri', sans-serif !important;
                        font-weight: 700 !important;
        ...
        with st.spinner("🔍 Reading Success Criteria..."):
            try:
                ...
                if sc_extracted:
                    ...
                    # Custom styled text area for SC preview
                    st.markdown("""
                    <style>
                    div[data-testid="stTextArea"] textarea[aria-label="Extracted SC (edit if needed):"] {
                        color: #000000 !important;
                        font-family: 'Calibri', sans-serif !important;
                        font-weight: 700 !important;
                        font-size: 14px !important;
...
<div style="font-size:14px;color:#ffffff;line-height:1.6">⚠️ AI read the handwriting below. Please review and fix any mistakes before assessment.</div>
                ...
                # Add custom styling for corrected writing text area
                st.markdown("""
                <style>
                div[data-testid="stTextArea"] textarea[aria-label="✏️ Review & correct the extracted text:"] {
                    color: #000000 !important;
                    font-family: 'Calibri', sans-serif !important;
                    font-weight: 700 !important;
                    font-size: 16px !important;
